...
public class Main extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Thread() {
            ...
            public void run()
            {
                Log.e("CodecThread","Running begin191");
                try
                ...
                {
                    Log.e("CodecThread", "Run error11");
                    e.printStackTrace();
                    Log.e("CodecThread", "Run error12");
                }
                ...
                {
                    Log.e("CodecThread", "Run error21");
                    throwable.printStackTrace();
                    Log.e("CodecThread", "Run error22");
                }

                Log.e("CodecThread","Running end192");
            }
        }.start();
    ...
    public void testEncodeCameraToMp4() throws Throwable {
        Log.e("CodecThread","Test_watch _1");
    ...
    private static class CameraToMpegWrapper implements Runnable {
        ...
        private CameraToMpegWrapper(Main test) {
            mTest = test;
        }
        ...
        public void run() {
            try {
                Thread.sleep(5000);
                Log.e("CodecThread","Test_watch _3");
        ...
        /** Entry point. */
        public static void runTest(Main obj) throws Throwable {

            Log.e("CodecThread","Test_watch _2");
    ...
    private void encodeCameraToMpeg() {
        ...
        Log.e("CodecThread","Test_watch _4");
        ...
        Log.e(TAG, MIME_TYPE + " outputdata " + encWidth + "x" + encHeight + " @" + encBitRate);

        Log.e("CodecThread","Test_watch _5");
        ...
        try {
            ...
            Log.e("CodecThread","Test_watch _6");
            ...
            while (System.nanoTime() < desiredEnd) {
                ...
                Log.e("CodecThread","Test_watch _7: "+System.nanoTime()+"-->"+desiredEnd+"--("+(desiredEnd-System.nanoTime())+")");
                ...
                // argument.
                Log.e("CodecThread","Test_watch _8");
                try {
                    mStManager.awaitNewImage();
                }
                catch (Throwable t)
                {
                    Log.e("CodecThread","Test_watch _9-1");
                    t.printStackTrace();
                }
                Log.e("CodecThread","Test_watch _9");
                ...
                Log.e("CodecThread","Test_watch _10");
                mInputSurface.setPresentationTime(st.getTimestamp());
                Log.e("CodecThread","Test_watch _11");
                ...
                Log.e("CodecThread","Test_watch _12");
            }
    ...
    private void prepareEncoder(int width, int height, int bitRate) {
        ...
        if (VERBOSE) Log.e(TAG, "format: " + format);
    ...
    private void releaseEncoder() {
        if (VERBOSE) Log.e(TAG, "releasing encoder objects");
        if (mEncoder != null) {
            mEncoder.stop();
            mEncoder.release();
            mEncoder = null;
    ...
    private void drainEncoder(boolean endOfStream) {
        ...
        if (VERBOSE) Log.e(TAG, "drainEncoder(" + endOfStream + ")");
    ...
    private static class SurfaceTextureManager
        ...
        private Main.STextureRender mTextureRender;
        ...
        public SurfaceTextureManager() {
            mTextureRender = new Main.STextureRender();
            mTextureRender.surfaceCreated();

            if (VERBOSE) Log.e(TAG, "textureID=" + mTextureRender.getTextureId());
            ...
            synchronized (mFrameSyncObject) {
                while (!mFrameAvailable) {
                    try {
                        ...
                        // shouldn't happen
                        Log.e("awaitNewImage","error here1");
                        ie.getStackTrace();
                        Log.e("awaitNewImage","error here2");
        ...
        public void onFrameAvailable(SurfaceTexture st) {
            if (VERBOSE) Log.e(TAG, "new frame available");
            synchronized (mFrameSyncObject) {
                if (mFrameAvailable) {
